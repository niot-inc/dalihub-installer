...
- **하드웨어**: Raspberry Pi 4 (또는 HAT 펌웨어 v15 이상과 Pi 5) + DALI HAT — [ATX LED Raspberry Pi to DALI Co-Processor HAT](https://atx-led.com/products/atx-led%C2%AE-raspberry-pi-to-dali-co-processor) (1/2/4채널)
...
> Raspberry Pi 5에서는 위 config.txt 설정 대신 `dtparam=uart0=on`이 적용됩니다. (Pi 5는 Bluetooth 비활성화가 필요 없습니다.)
