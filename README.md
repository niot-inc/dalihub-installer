...
- **Hardware**: Raspberry Pi 4 (or Pi 5 with HAT firmware v15+) + DALI HAT — [ATX LED Raspberry Pi to DALI Co-Processor HAT](https://atx-led.com/products/atx-led%C2%AE-raspberry-pi-to-dali-co-processor) (1/2/4-channel)
...
> On a Raspberry Pi 5, `dtparam=uart0=on` is applied instead of the config.txt settings above (Bluetooth does not need to be disabled on Pi 5).
